...
<header>
    ...
    <p>Feinstaub Bernau am Chiemsee - Feinstaubbelastung, Temperatur, Luftfeuchtigkeit</p>
                           ...
                           <div class="col-12">
											<ul class="actions">
												<li><p>Ausgewähltes Jahr:</p></li>
												<li><select name="Choosed_year_name" id="Choosed_year">
  ...
  <option value="2018">2018</option>
     ...
     <input onclick="ajax_yearly_data();" type="submit" value="Daten des ganzen Jahres anzeigen" class="primary"/>
...
function ajax_yearly_data() {
    ...
    var gewaehltesJahr = document.getElementById('Choosed_year').value; //get choosed year from selector
    $.ajax({
                type: "POST",
                data: {data: gewaehltesJahr},//send data from selector to php file with POST methode
                url: "get_airdata_mysql_yearly_v3.php", //file we want to get our data from
                dataType: "json",
                cache: false,
                error: function() {
