...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li><a href="#Home" class="page-scroll" style="display: none"><a href="https://www.sefrey.de/index.php"><i class="fa fa-home"></i> Home</a></a></li>
        ...
        <li><a href="#Contact" class="page-scroll" style="display: none"><a href="http://sefrey.de#contact">Kontakt</a></a></li>
            <li><a onclick="OpenSubmenu()" >Mehr <i class="fa fa-caret-down"></i></a></li>
        </ul> 
      </div>
      <div id="submenu">
        ...
        <li><a onclick="CloseSubmenu()">Weniger <i class="fa fa-caret-up"></i></a></li>
        </ul>
      </div>
